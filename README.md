...
make
```
即可启动虚拟机，可以看到屏幕展示出两次内存读取段内容，说明我们已经成功进入了保护模式,并且可以读写超过1MB以上段内存,并且在做完一切后,还顺利返回了DOS命令行。
![f11dca778e11cf4589ce1ba87ecbf49f.png](https://i.mjj.rip/2023/06/04/f11dca778e11cf4589ce1ba87ecbf49f.png)
# 备注
