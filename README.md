...
make
```
即可启动虚拟机，可以看到我们通过retf回到了ring3的代码段，打印了一个红色的“3”（从高特权级转移到低特权级）。

![c6a386fa702ab15cc971cba2a882598f.png](https://i.mjj.rip/2023/06/07/c6a386fa702ab15cc971cba2a882598f.png)

随后我们通过在ring3代码中call一个指向ring0代码段的ring3调用门，重新进入ring0代码，打印出了一个红色的“C”。
