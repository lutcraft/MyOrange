...
make
```
即可启动虚拟机，可以看到在之前用LDT打印出的红色“L”，上方还多出了一个红色的“C”，这便是我们利用CALL调用门的方式执行的（同特权级调用）。
![f5bcc794b10bd102de02eb19f2371553.png](https://i.mjj.rip/2023/06/06/f5bcc794b10bd102de02eb19f2371553.png)
