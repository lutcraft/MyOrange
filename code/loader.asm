...
%include	"code/load.inc"
%include	"code/GDTHead.inc"
...
LABEL_PM_START:
	...
	push	szMemChkTitle	;"BaseAddrL BaseAddrH LengthLow LengthHigh   Type"
	call	DispStr
	add	esp, 4
